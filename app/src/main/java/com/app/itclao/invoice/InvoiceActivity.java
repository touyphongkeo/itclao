...
import com.app.itclao.viewpayment.ViewpaymentActivity;
...
public class InvoiceActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("ລາຍການໃບບີນຮັບເງີນ");
      ...
      // getCustomerData();
       ...
       // etxtSearch.setText(stock_id);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(() -> {
            if (utils.isNetworkAvailable(InvoiceActivity.this)) {
                getCustomerData("");
            } else {
                Toasty.error(InvoiceActivity.this, R.string.no_network_connection, Toast.LENGTH_SHORT).show();
            }
        ...
        fabAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(InvoiceActivity.this, ViewpaymentActivity.class);
    ...
    public void getCustomerData(String searchText) {
        ...
        Call<List<Invoince>> call;
        call = apiInterface.get_invoice(searchText,stock_id.toString());
        call.enqueue(new Callback<List<Invoince>>() {
            @Override
            public void onResponse(@NonNull Call<List<Invoince>> call, @NonNull Response<List<Invoince>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    List<Invoince> customerList;
                    ...
                    if (customerList.isEmpty()) {
                        ...
                        InvoiceAdapter invoiceAdapter = new InvoiceAdapter(InvoiceActivity.this, customerList);
                        recyclerView.setAdapter(invoiceAdapter);
                    }
                }
            }
            @Override
            public void onFailure(@NonNull Call<List<Invoince>> call, @NonNull Throwable t) {
                Toast.makeText(InvoiceActivity.this, R.string.something_went_wrong, Toast.LENGTH_SHORT).show();
