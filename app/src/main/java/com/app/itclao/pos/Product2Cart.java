...
public class Product2Cart extends BaseActivity {
    ...
    DatabaseAccess databaseAccess = DatabaseAccess.getInstance(Product2Cart.this);
    DecimalFormat f;
    String invoiceIds;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_product2_cart);
        ...
        img_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Product2Cart.this,Pos2Activity.class);
        ...
        if (cartProductList.isEmpty()) {
            ...
            CartAdapter = new CartAdapter(Product2Cart.this, cartProductList, txtTotalPrice, btnSubmitOrder, imgNoProduct, txtNoProduct);
    ...
    public void proceedOrder(String customerName) {
        databaseAccess = DatabaseAccess.getInstance(Product2Cart.this);
        databaseAccess.open();
        ...
        if (itemCount > 0) {
            ...
            double qty2,pr2;
            if (lines.isEmpty()) {
                Toasty.error(Product2Cart.this, "ບໍມີລາຍການອາຫານ", Toast.LENGTH_SHORT).show();
            } else {
...
//                    obj.put("sale_status", user);
                    ...
                    for (int i = 0; i < lines.size(); i++) {
                        ...
                        databaseAccess.open();
                        String sale_bill = lines.get(i).get("sale_bill");
...
//                        objp.put("product_price", lines.get(i).get("product_price"));
                ...
                if(utils.isNetworkAvailable(Product2Cart.this)) {
                    orderSubmit(obj);
                } else {
    ...
    private void orderSubmit(final JSONObject obj){
        ...
        Call<String> call = apiInterface.submitOrderss(body2);
        call.enqueue(new Callback<String>() {
            @Override
            public void onResponse(@NonNull Call<String> call, @NonNull Response<String> response) {
                if (response.isSuccessful()) {
                    progressDialog.dismiss();
                   // Toasty.success(Product2Cart.this, "ສັ່ງສຳເລັດ", Toast.LENGTH_SHORT).show();
                    databaseAccess.open();
                    databaseAccess.emptyCart();
                    dialogSuccess();
                } else {
                    Toasty.error(Product2Cart.this, R.string.error, Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();
    ...
    public void dialogSuccess() {
        AlertDialog.Builder dialog = new AlertDialog.Builder(Product2Cart.this);
        ...
        dialogBtnCloseDialog.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(Product2Cart.this, HomeActivity.class);
            startActivity(intent);
            finish();
        });
            ...
            public void onResponse(@NonNull Call<List<Customer>> call, @NonNull Response<List<Customer>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    for (int i = 0; i < customerData.size(); i++) {
                        customerNames.add(customerData.get(i).getCustomer_name());
                    }
                }
            }
            @Override
