...
public class CartorderAdapter extends RecyclerView.Adapter<CartorderAdapter.MyViewHolder> {
    ...
    public CartorderAdapter(Context context, List<HashMap<String, String>> cartProduct, TextView txtTotalPrice, Button btnSubmitOrder, ImageView imgNoProduct, TextView txtNoProduct) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cart_product_item22, parent, false);
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, int position) {
        ...
        databaseAccess.open();
        totalPrice = databaseAccess.getTotalitem_productorder();
        ...
        holder.img_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                databaseAccess.open();
                boolean deleteProduct = databaseAccess.deleteProductFromCartorder(Id);
                if (deleteProduct) {
