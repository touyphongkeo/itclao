...
public class CatgoryposAdapter extends RecyclerView.Adapter<CatgoryposAdapter.MyViewHolder> {
    ...
    public CatgoryposAdapter(Context context, List<Catgory> customerData, RecyclerView recycler_views, ImageView imgNoProduct, TextView txtNoProducts, ShimmerFrameLayout mShimmerViewContainer) {
    ...
    @NonNull
    @Override
    public CatgoryposAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final CatgoryposAdapter.MyViewHolder holder, int position) {
        ...
        holder.card_category.setOnClickListener(new View.OnClickListener() {
           ...
           // player.start();
            //  Toast.makeText(context, categoryId, Toast.LENGTH_SHORT).show();
              getProductsData(categoryId,stock_id);
...
//            context.startActivity(i);
    ...
    public void getProductsData(String Group_ID,String stock_id) {
        ApiInterface apiInterface = ApiClient.getApiClient().create(ApiInterface.class);
        Call<List<Product2>> call;
        call = apiInterface.get_catgoryId2(Group_ID,stock_id);
            ...
            public void onResponse(@NonNull Call<List<Product2>> call, @NonNull Response<List<Product2>> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (productsList.isEmpty()) {
                        ...
                        PsporoductAdapter psporoductAdapter = new PsporoductAdapter(context, productsList);
