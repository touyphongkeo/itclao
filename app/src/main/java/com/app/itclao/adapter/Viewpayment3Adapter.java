...
public class Viewpayment3Adapter extends RecyclerView.Adapter<Viewpayment3Adapter.MyViewHolder> {


    Context context;
    private List<quotation_transfer> orderData;
    ...
    public Viewpayment3Adapter(Context context, List<quotation_transfer> orderData, TextView telphon, TextView usernaes, TextView idsssss, TextView text_v2, TextView text_v7, TextView text_v9) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.viewpaymoney3, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.txtProductName.setText(orderData.get(position).gettransfer_id());

        holder.txtProductPrice.setText(orderData.get(position).getProduct_Name());

        holder.txtTotalCost.setText(orderData.get(position).getqty());

       // holder.txt_qty.setText(orderData.get(position).gettime());
        telphon.setText("ລະຫັດຜູ້ຂາຍ: "+shopEmail+" "+ Fname);
